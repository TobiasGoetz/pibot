...
class Bot(discord.ext.commands.Bot):
    ...
    def __init__(self, config: BotConfig, *args, **kwargs) -> None:
        ...
        self._settingsCache = RedisSettingsCache(Redis.from_url(config.redisUri))
    ...
    async def close(self) -> None:
        """Close Discord, Redis, and MongoDB connections."""
    ...
    async def on_message(self, message: discord.Message, /) -> None:
        ...
        general = await self.guildSettings.load(message.guild.id, GeneralConfig)
